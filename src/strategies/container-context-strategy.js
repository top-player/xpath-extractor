    ...
    hasUniqueIdentifier(element) {
      ...
      if (element.className) {
        ...
        if (classNameStr && typeof classNameStr === 'string') {
          const classes = classNameStr.split(/\s+/).filter(cls => cls);
    ...
    getContainerXPath(container) {
      ...
      if (container.className) {
        ...
        if (typeof container.className === 'string') {
          classNameStr = container.className;
        } else if (container.className.baseVal !== undefined) {
          classNameStr = container.className.baseVal;
        } else if (container.className.toString) {
          classNameStr = container.className.toString();
        }
